		...
		<div class="wrapper wrapper--w680">
			<div class="card card-4">
				<div class="card-body">
					...
					<form:form method="post" name="addForm" action="${ctx}/add"
							...
							<div class="col-2">
								<div class="input-group">
									...
									<form:input path="firstName" class="input--style-4" type="text"
										placeholder="required" name="fname" pattern="^[a-zA-Z\s]*$"
							...
							<div class="col-2">
								<div class="input-group">
									...
									<form:input path="lastName" class="input--style-4" type="text"
										placeholder="required" name="lname" pattern="^[a-zA-Z\s]*$"
							...
							<div class="col-2">
								<div class="input-group">
									...
									<form:input path="email" class="input--style-4" type="email"
										placeholder="required" name="email" required="true" />
								</div>
							</div>
							<div class="col-2">
								<div class="input-group">
						...
						<div class="row row-space">
							<div class="col-2">
								<div class="input-group">
									...
									<form:input path="password" class="input--style-4"
